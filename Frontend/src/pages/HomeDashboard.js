  ...
  return (
    <div className="health-dial">
      <svg width="160" height="90" viewBox="0 0 160 90">
        ...
        <path
          d="M 10 85 A 70 70 0 0 1 150 85"
          fill="none" stroke="#1D4ED8" strokeWidth="12" strokeLinecap="round"
...
function SystemSettings() {
  ...
  // Filter settings sections by the search query
  const q = settingsSearch.toLowerCase();
  const showConfig  = !q || ["rule", "ml", "anomaly", "weight", "config"].some((k) => k.includes(q));
  const showReview  = !q || ["review", "threshold", "approve", "auto"].some((k) => k.includes(q));
